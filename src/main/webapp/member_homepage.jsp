...
if(lastRow > 0){
	...
	if(currentPage>1){
%>
	<a href="member_homepage.jsp?pageNum=<%=currentPage-1%>">[이전]</a>
<%
	}
	while(setPage <= lastPage){
%>
	<a href="member_homepage.jsp?pageNum=<%=setPage%>">[<%=setPage %>]</a>
<%
		setPage = setPage +1;
	}
	if(lastPage > currentPage) {
%>
	<a href="member_homepage.jsp?pageNum=<%=currentPage+1%>">[다음]</a>
<%
	}
}
%>
